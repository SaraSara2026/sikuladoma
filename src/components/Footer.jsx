export default function Footer({ onOrder, onReg, onKontakt, onHow, onSikuly, onPodminkySikuly, onPodporaSikuly, onOchrana, onPodminkyPouziti, onGDPR, onCookies, onFAQ, onSikulove }) {
  ...
  return (
    <footer style={{ background: "#F3F6FA", borderTop: "1px solid #CBD5E1", color: link, padding: "32px 24px 16px" }}>
      <div style={{ maxWidth: 1060, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1.8fr 1fr 1fr 1fr", gap: 32, marginBottom: 24 }}>
          ...
          <div>
            <h4 style={{ color: "#0F172A", fontSize: 11, fontWeight: 700, marginBottom: 12, letterSpacing: ".08em", textTransform: "uppercase" }}>Pro zákazníky</h4>
            {[
          ...
          <div>
            <h4 style={{ color: "#0F172A", fontSize: 11, fontWeight: 700, marginBottom: 12, letterSpacing: ".08em", textTransform: "uppercase" }}>Pro šikuly</h4>
            {[
          ...
          <div>
            <h4 style={{ color: "#0F172A", fontSize: 11, fontWeight: 700, marginBottom: 12, letterSpacing: ".08em", textTransform: "uppercase" }}>Právní</h4>
            {[
        ...
        <div style={{ borderTop: "1px solid #CBD5E1", paddingTop: 12, display: "flex", justifyContent: "space-between", fontSize: 12, flexWrap: "wrap", gap: 8, color: "#64748B" }}>
